...
import com.nextos.eplayer.media.media.MediaLibraryItem;
...
public class Tools {
    ...
    public static String millisToString(long millis) {
        Log.d("JYL_time", "millisToString: " + millis);
     ...
     * @return formated string (hh:)mm:ss
     */
    public static String millisToStringTime(long millis, SeekBar seekBar) {
        Log.d("JYL_time", "millisToString: ");
        if (seekBar != null) {
            long progress = seekBar.getProgress();
            Log.d("JYL_time", "millisToString: " + progress);
            return millisToString(progress, false, true, false);
        }else {
            return millisToString(millis, false, true, false);
        }
    }
     ...
     * @return formated string (hh:)mm:ss
     */
    public static String seekBarToStringTime(long millis, SeekBar seekBar) {
        Log.d("JYL_time", "millisToString: ");
        if (seekBar != null) {
            long progress = seekBar.getProgress();
            Log.d("JYL_time", "millisToString: " + progress);
     ...
     * @return formated string (hh:)mm:ss
     */
    public static String millisToStringMusic(long millis) {
        Log.d("JYL_time", "millisToString: " + millis);
        return millisToString(millis*1000, false, true, false);
    }
    ...
    public static void setMediaDescription (MediaLibraryItem item) {
        if (item.getItemType() == MediaLibraryItem.TYPE_MEDIA) {
            ...
            if (mw.getType() == MediaWrapper.TYPE_VIDEO) {
                ...
                Log.d(TAG, "setMediaDescription: " + sb.toString());
