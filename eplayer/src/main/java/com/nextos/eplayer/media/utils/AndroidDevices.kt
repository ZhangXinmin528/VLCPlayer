...
import com.nextos.eplayer.media.containsName
import com.nextos.eplayer.media.getFileNameFromPath
import com.nextos.eplayer.media.getPackageInfoCompat
import com.nextos.eplayer.media.startsWith
...
object AndroidDevices {
    ...
    object MediaFolders {
        ...
        val EXTERNAL_PUBLIC_MOVIES_DIRECTORY_URI = getFolderUri(
        ...
        val EXTERNAL_PUBLIC_PODCAST_DIRECTORY_URI = getFolderUri(
            EXTERNAL_PUBLIC_PODCAST_DIRECTORY_FILE
        )
        val EXTERNAL_PUBLIC_DOWNLOAD_DIRECTORY_URI = getFolderUri(
            EXTERNAL_PUBLIC_DOWNLOAD_DIRECTORY_FILE
        )
        ...
        val EXTERNAL_PUBLIC_SCREENSHOTS_URI_DIRECTORY = getFolderUri(
