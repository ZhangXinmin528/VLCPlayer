...
package com.nextos.core.decoration;
...
public class GridDividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public GridDividerItemDecoration(Context context, int spanCount) {
        this(context, spanCount, 1f, Color.parseColor("#EFEFEF"));
    }

    public GridDividerItemDecoration(Context context, int spanCount, float dividerWidth,@ColorInt int colorInt) {
