...
import com.nextos.module.playermodule.tools.Preferences
...
object VLCOptions {
    ...
    val libOptions: ArrayList<String>
        get() {
            ...
            val timeStrechingDefault = context.resources.getBoolean(R.bool.player_time_stretching_default)
            ...
            val freetypeShadowColor = Integer.decode(String.format("0x%06X", (0xFFFFFF and pref.getInt("subtitles_shadow_color", ContextCompat.getColor(context, R.color.player_black)))))
    ...
    fun isAudioDigitalOutputEnabled(pref: SharedPreferences) = pref.getBoolean("audio_digital_output", true)
