...
import com.nextos.module.playermodule.tools.dp
...
//    fun getPictureFromCache(media: VodMedia): Bitmap? {
...
//    }
    ...
    fun makeTransparentBackground(context: Context, width: Int = 48.dp): Bitmap {
        val colorLight = ContextCompat.getColor(context, R.color.player_grey500)
        val colorDark = ContextCompat.getColor(context, R.color.player_grey700)
        val paint = Paint()
