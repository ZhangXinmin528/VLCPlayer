...
import com.nextos.module.playermodule.tools.LiveDataset
import com.nextos.module.playermodule.tools.NetworkMonitor
import com.nextos.module.playermodule.tools.isAppStarted
import com.nextos.module.playermodule.tools.retry
...
object RendererDelegate : RendererDiscoverer.EventListener {
    ...
    init {
        NetworkMonitor.getInstance(AppContextProvider.appContext).connectionFlow.onEach { if (it.connected) start() else stop() }.launchIn(
            AppScope
        )
    }
