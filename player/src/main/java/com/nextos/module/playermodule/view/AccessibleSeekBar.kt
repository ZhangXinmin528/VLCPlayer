package com.nextos.module.playermodule.view
...
import com.nextos.module.playermodule.helper.TalkbackUtil
...
class AccessibleSeekBar : AppCompatSeekBar {
    ...
    private val customAccessibilityDelegate = object : AccessibilityDelegateCompat() {
        ...
        override fun sendAccessibilityEventUnchecked(host: View?, event: AccessibilityEvent) {
            ...
            contentDescription = context.getString(R.string.player_talkback_out_of, TalkbackUtil.millisToString(context, progress.toLong()), TalkbackUtil.millisToString(context, max.toLong()) )
