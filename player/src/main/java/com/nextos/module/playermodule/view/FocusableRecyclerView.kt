...
import com.nextos.module.playermodule.interfaces.AudioListItemAdapter
import com.nextos.module.playermodule.interfaces.FocusListener
import com.nextos.module.playermodule.util.getScreenHeight
...
class FocusableRecyclerView : RecyclerView {
    ...
    override fun setAdapter(adapter: Adapter<*>?) {
        ...
        if (adapter is AudioListItemAdapter) {
